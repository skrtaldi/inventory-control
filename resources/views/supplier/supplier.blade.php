        ...
        <main class="container">
            ...
            <div class="my-3 p-3 bg-body shadow-sm"
                ...
                <div class="pb-3 d-flex justify-content-end">
                    <form class="d-flex w-70" action="{{ url('supplier') }}" method="get">
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <a href="#modalDelete" data-toggle="modal" onclick="$('#modalDelete #formDelete').attr('action', '{{ url('admin/' . $supp->kode) }}')" class="btn btn-danger btn-sm">
                                            <i class="fas fa-trash"></i>
                                            Hapus
                                        </a>
                                    </div>
